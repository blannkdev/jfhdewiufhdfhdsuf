...
if (strpos($result2, "Thank you john!")) {
	echo 'CHARGED</span>  </span>CC:  ' . $lista . '</span>  <br>➤ Response: $25 Charged ✅ <br> ➤ Gate : Shopify gateway <br>';
	...
	echo 'CVV</span>  </span>CC:  ' . $lista . '</span>  <br>Result: Street address and postal code do not match ✅[MISMATCH] </span><br> ➤ Gate : Shopify gateway <br>';
} elseif (strpos($result2, "insufficient_funds")) {
	echo 'CVV</span>  </span>CC:  ' . $lista . '</span>  <br>Result: INSUFFICIENT FUNDS ✅ </span><br>➤ Gate : Shopify gateway<br>';
